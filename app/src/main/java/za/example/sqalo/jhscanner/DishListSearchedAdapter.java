...
public class DishListSearchedAdapter extends ArrayAdapter<String> {
    ...
    public DishListSearchedAdapter(Activity context, ArrayList<Bitmap> image, ArrayList<String> name, ArrayList<String> keyingredient, ArrayList<String> recipe) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rootView = inflater.inflate(R.layout.lsttemplatedishsearched, null, true);
