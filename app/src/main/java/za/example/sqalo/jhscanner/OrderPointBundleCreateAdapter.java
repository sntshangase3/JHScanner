...
public class OrderPointBundleCreateAdapter extends ArrayAdapter<String> {
    ...
    public OrderPointBundleCreateAdapter(Activity context, ArrayList<Bitmap> image, ArrayList<String> name) {
        super(context, R.layout.lsttemplateorderpointseach, name);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rootView = inflater.inflate(R.layout.lsttemplateorderpointseach, null, true);
