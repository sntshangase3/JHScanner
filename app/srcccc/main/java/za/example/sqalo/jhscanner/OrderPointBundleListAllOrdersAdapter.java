...
public class OrderPointBundleListAllOrdersAdapter extends ArrayAdapter<String> {
    ...
    public OrderPointBundleListAllOrdersAdapter(Activity context, ArrayList<Bitmap> image, ArrayList <String> name, ArrayList <String> quantity, ArrayList <String> orderdate,
                                                ArrayList <String> status,ArrayList <String> cost) {
